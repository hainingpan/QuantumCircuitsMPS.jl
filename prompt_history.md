...
```
3. Design philosophy, Here a flow chart demonstrating idea would be helpful.

4. Install, dependencies

5. Quickstart: example, here we can use the convention MIPT
